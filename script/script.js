   ...
   const productos = {
    ...
    juegoMesa: { 
        nombre: 'Mundo Jurásico (Juego de mesa)', 
        precio: 50000, 
        stock: 10,
        descuento: 0.05
    },
    surtidos: { 
        nombre: 'Muñecos surtidos', 
        precio: 3000, 
        stock: 50,
        descuento: 0.1
    },
    disfraz: {
        nombre: 'Disfraz de T-rex',
        precio: 150000,
        stock: 5,
        descuento: 0
    },
    lampara: {
        nombre: 'Lámpara de triceratops',
        precio: 90000,
        stock: 5,
        descuento: 0.25
    },
    libro: {
        nombre: 'Parque Jurásico (Libro)',
        precio: 25000,
        stock: 12,
        descuento: 0.05
    }
...
// Clase 11 - Función para mostrar productos en consola
...
// Clase 12 - Función para mostrar info de los productos
function mostrarInfo(productoKey) {
    // Obtener el producto específico
    const producto = productos[productoKey]

    // Obtener el ul donde ira la info
    const ul = document.getElementById(`info-${productoKey}`)
    ul.innerHTML = '' // Borra el contenido para evitar duplicados

    //Crear elementos li con la info de productos e insertarlos en ul
    ...
    descuento.textContent = `Descuento: ${producto.descuento * 100}%`
    ul.appendChild(descuento)
   
}

function ocultarInfo(productoKey) {
    //Obtener el ul donde esta la info
    const ul = document.getElementById(`info-${productoKey}`)
    //Borrar contenido
    ul.innerHTML = ''
}
